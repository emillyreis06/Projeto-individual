...
pratica_ativFisica char (4),
constraint chkQual check (pratica_ativFisica in ("Sim","Não")),
qual_ativFisica varchar (15),
constraint chkPratica check (qual_ativFisica in ("Musculação","Crossfit","Esporte","Outro")),
