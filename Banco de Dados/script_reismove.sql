...
obj varchar (45),
constraint chkObj check (obj in ("Ganhar massa magra", "Emagrecer", "Bem estar físico e mental", "Saúde")),
fkUsuario int,
...
-- conta quantas pessoas respodeu o formulario
SELECT count(*) as 'Total de Respostas' from formulario;

-- quantas pessoas praticam atividade fisica
select count(*) from formulario where  pratica_ativFisica = 'Sim';


-- qual o obejtivo mais selecionado pelas pessoas 
